...
The [`drawImage`](https://ej2.syncfusion.com/javascript/documentation/api/image-editor/#drawImage) method in the Image Editor control takes six parameters to define the properties of the rectangle annotation:
...
In the following example, you can use the [`drawImage`](https://ej2.syncfusion.com/javascript/documentation/api/image-editor/#drawImage) method in the button click event.
